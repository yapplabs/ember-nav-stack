...
function myScheduleRoutes(dsl, resetNamespace = false) {
  dsl.route('my-schedule', { resetNamespace }, function () {
    this.route(
      'schedule-item',
      { path: '/schedule-items/:schedule_item_id' },
      function () {
...
let dsl = function () {
  this.route('yapp', { path: '/yapp/', resetNamespace: true }, function () {
    ...
    this.route(
      'page',
      { path: '/pages/:page_id', resetNamespace: true },
      function () {
        ...
        this.route(
          'schedule-item',
          { path: '/schedule-items/:schedule_item_id', resetNamespace: true },
          function () {
            this.route('rating-form');
            this.route('person');
        ...
        this.route(
          'track',
          { path: '/tracks/:track_id', resetNamespace: true },
          function () {
            // track_id is "all" or UUID
            this.route(
              'schedule-item',
              { path: '/schedule-items/:schedule_item_id' },
              function () {
